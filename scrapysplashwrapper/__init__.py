...
def crawl(splash_url: str, url: str, *, cookies: Optional[List[Dict[Any, Any]]]=None, referer: Optional[str]=None, depth: int=1,
    ...
    def _crawl(queue: 'Queue[Any]', splash_url: str, ua: str, url: str,
        ...
        crawler = ScrapySplashWrapperCrawler(splash_url=splash_url, useragent=ua, cookies=cookies,
                                             referer=referer, depth=depth, log_enabled=log_enabled, log_level=log_level)
